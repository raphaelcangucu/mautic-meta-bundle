...
class MetaConnection extends FormEntity
{
    ...
    public function setAppId(string $appId): self { $this->appId = trim($appId); return $this; }
    public function getEncryptedAppSecret(): string { return $this->encryptedAppSecret; }
    public function setEncryptedAppSecret(string $value): self { $this->encryptedAppSecret = $value; return $this; }
    public function getEncryptedAccessToken(): string { return $this->encryptedAccessToken; }
    public function setEncryptedAccessToken(string $value): self { $this->encryptedAccessToken = $value; return $this; }
    public function getEncryptedVerifyToken(): string { return $this->encryptedVerifyToken; }
    public function setEncryptedVerifyToken(string $value): self { $this->encryptedVerifyToken = $value; return $this; }
    public function getGraphVersion(): string { return $this->graphVersion; }
    public function setGraphVersion(string $value): self { $this->graphVersion = trim($value); return $this; }
    public function getStatus(): string { return $this->status; }
    public function setStatus(string $status): self { $this->status = $status; return $this; }
    public function getTokenExpiresAt(): ?\DateTimeInterface { return $this->tokenExpiresAt; }
    public function setTokenExpiresAt(?\DateTimeInterface $value): self { $this->tokenExpiresAt = $value; return $this; }
    /**
    ...
    public function addAsset(MetaAsset $asset): self { if (!$this->assets->contains($asset)) { $this->assets->add($asset); $asset->setConnection($this); } return $this; }
    public function removeAsset(MetaAsset $asset): self { $this->assets->removeElement($asset); return $this; }
}
