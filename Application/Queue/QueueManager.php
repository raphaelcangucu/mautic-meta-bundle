...
final class QueueManager
{
    ...
    {
        if (str_starts_with((string) $job->getIdempotencyKey(), 'igc:') || 'uncertain' === $job->getStatus()) {
            throw new \DomainException('This operation has an uncertain outcome and cannot be retried blindly.');
        }
